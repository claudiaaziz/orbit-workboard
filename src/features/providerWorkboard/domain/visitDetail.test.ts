...
describe('visitDetail', () => {
    it('builds visit detail fields from a visit and field context', () => {
        ...
        const model = buildVisitDetailModel(visit, MOCK_WORKBOARD_CONTEXT);
    ...
    it('shows scan mismatch and pending evidence on edge visits', () => {
        ...
        const blockedModel = buildVisitDetailModel(blockedVisit, MOCK_WORKBOARD_CONTEXT);
        ...
        const proofModel = buildVisitDetailModel(needsProofVisit, MOCK_WORKBOARD_CONTEXT);
    ...
    it('returns no actions for completed visits', () => {
        ...
        const model = buildVisitDetailModel(visit as ServiceVisit, MOCK_WORKBOARD_CONTEXT);
